...
@Repository
public interface DeviceModelManufacturerRepository extends JpaRepository<DeviceModelManufacturer, DeviceModelManufacturerPK>  , JpaSpecificationExecutor<DeviceModelManufacturer> {
